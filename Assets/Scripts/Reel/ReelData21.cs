...
namespace ReelSpinGame_Reels
{
    public class ReelData21
    {
        ...
        // コンストラクタ
        public ReelData21(int lowerPos, StreamReader arrayData) 
        {
            // 位置設定
            // もし位置が0~20でなければ例外を出す
        ...
        // 21図柄リール用
        public ReelSymbols GetReelSymbol21(int posID) => ReturnSymbol(ReelArray[OffsetReel(currentLower + posID)]);
